class MercadoPagoTransactionDetail {
  ...
  static List<MercadoPagoTransactionDetail> fromJsonList(
      List<dynamic> jsonList) {
    List<MercadoPagoTransactionDetail> toList = [];
    for (var item in jsonList) {
      MercadoPagoTransactionDetail model =
          MercadoPagoTransactionDetail.fromJson(item);
      toList.add(model);
    }
    return toList;
  }

  MercadoPagoTransactionDetail.fromJson(Map<String, dynamic> json) {
